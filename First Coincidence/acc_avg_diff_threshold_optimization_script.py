...
averaged differences threshold, gain,
and loss metrics leaving every session
out for a single subject.
...
if __name__ == "__main__":
    ...
    es_save_vals(
        results,
        "Acc Avg Diff Threshold - First Coincidence",
