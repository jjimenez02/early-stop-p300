...
the predicted stimuli by Soft-Voting and with
a particular significance level specified via
parameters. The results will be averaged along
...
if __name__ == "__main__":
    ...
    es_save_vals(
        results,
        "Acc Evid Stat Test - Fixed alpha:" +
