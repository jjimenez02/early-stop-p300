...
all the stimulus at a particular significance
level specified via parameters. The results will
be averaged along every session out for a single
subject.
