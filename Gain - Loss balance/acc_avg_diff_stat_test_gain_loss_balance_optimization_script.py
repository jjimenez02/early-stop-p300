...
the gain & loss metrics and performing
the aforementioned test just over the
averaged differences between predicted
stimulus.
...
if __name__ == "__main__":
    ...
    es_save_vals(
        results,
        f"Acc Avg Diff Stat Test - G-L Bal - {args.stat}" +
