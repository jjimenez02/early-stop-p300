...
REGEXP="Acc Avg Diff Stat Test - G-L Bal - mannwhitneyu - Bonferroni: False|Acc Avg Diff Stat Test - G-L Bal - ks_2samp - Bonferroni: False|Acc Avg Diff Stat Test - G-L Bal - custom_wilcoxon - Bonferroni: False|Acc Avg Diff Stat Test - G-L Bal - ttest_ind - Bonferroni: True|Acc Avg Diff Stat Test - G-L Bal - mannwhitneyu - Bonferroni: True|Acc Avg Diff Stat Test - G-L Bal - ttest_welch - Bonferroni: True|Acc Avg Diff Threshold - G-L Bal|Acc Evid Threshold - G-L Bal|Fixed Stop - G-L Bal"
